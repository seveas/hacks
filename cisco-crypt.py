#!/usr/bin/python
#
# Cisco password encryption/decryption functions. These can be used to
# encrypt/decrypt passwords found in Cisco VPN .pcf files (and maybe other
# places too)
# 
# Usable as a python module and as a standalone tool. Usage for the tool:
# ./cisco-crypt.py -d <hexdump>
# ./cisco-crypt.py -e <passphrase> [key]
#
